  ...
  .get(async (req, res) => {
    try {
      if (req.session.user) {
        ...
        var userLiked = checkUserLiked == 0 ? "active" : "";
        var userDisliked = checkUserLiked == 1 ? "active" : "";
        res.render('singlePost', {
          ...
          flagged: checkUserFlag,
          userLiked: userLiked,
          userDisliked: userDisliked,
          likes: checkTotalLikes.numLikes,
          dislikes: checkTotalLikes.numDisliked
        });
      }
      else {
